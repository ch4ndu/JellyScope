...
class MPVLib private constructor(nativePtr: Long) {
    ...
    /** The minimum native mpv log level requested for this instance. */
    enum class LogRequestLevel(
    ...
    /** Requests native messages at [level]; valid before native initialization. */
    fun requestLogMessages(level: LogRequestLevel): Int {
        checkCreated()
        return nativeRequestLogMessages(nativeInstance, level.nativeName)
    }
