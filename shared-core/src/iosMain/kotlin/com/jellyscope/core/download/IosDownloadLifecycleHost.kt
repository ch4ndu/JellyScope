...
internal class IosDownloadLifecycleHost(
    ...
    override suspend fun reassociate(work: DownloadExecutionWork): Result<Unit> =
        Result.failure(IllegalStateException("iOS has no surviving native download work to reassociate."))
